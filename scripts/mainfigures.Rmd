...
# load data
# S1 file
rawdata <- readr::read_csv(here::here("data", "growth_rawdata.csv")) %>%
  dplyr::mutate(strain = factor(strain, levels = c("N2","CB")))
# S2 file
pruneddata <- readr::read_csv(here::here("data", "growth_pruneddata.csv")) %>%
  dplyr::mutate(strain = factor(strain, levels = c("N2","CB")))
# S3 file
annotatedmap <- readRDS(here::here("data","annotatedmap.RDS"))
phenocross <- readRDS(here::here("data","phenocross.RDS"))
# S4 file
load(here::here("data","nilgeno.Rda"))

# S5 file
nilpruneddata <- readr::read_csv(here::here("data", "nils_pruneddata.csv"))

# data("eQTLpeaks")
# data("probe_info")

# S6 file
load(here::here("data","gene_annotations.Rda"))
```
