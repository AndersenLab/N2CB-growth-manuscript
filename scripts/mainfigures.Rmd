...
lod.TOF <- linkagemapping::maxlodplot(traitmap, tsize = 12) + labs(title = "") +
  ...
  theme(axis.text.x = element_blank()) + geom_hline(yintercept = 3, alpha = 0.3) 
...
```
```{r eval=FALSE, include=FALSE}
ggsave(here::here("figures", "Fig3.png"), plot = fig3[[3]], device = "png", width = 12, height = 6, units = "in", dpi = 300)
```
